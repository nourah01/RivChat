...
public class chatroocatog extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chatroocatog);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(chatroocatog.this, "No network connectivity", Toast.LENGTH_SHORT).show();
            }
        });
